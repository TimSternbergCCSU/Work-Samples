...
class MainProgram
{ 
    public static String NAME_OF_FILE = "ints.txt"; // Name of text file used for sorting
    ...
    private static void mainSort(SortType sort, Object dataType)
    {
        ...
        System.out.print("\nCompletely sorted: "); // This will be our best case because it's already sorted!
        sort.Sort(arr);
        
        System.out.print("\nSorted backwards: "); // This will be our worst case, since it's sorted in the exact OPPOSITE way we want it to be!
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        mainSort( new QuickSort(),     new IntegerType() );
        mainSort( new ShellSort(),     new IntegerType() );
        mainSort( new HeapSort(),      new IntegerType() );
    }
}